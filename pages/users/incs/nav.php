    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="<?php echo(URL) ?>">ACS</a>
     ...
     <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <!-- <li class="nav-item">
          <a class="nav-link" href="<?php echo URL; ?>viewdevices/">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo URL; ?>viewgroups/">
            <i class="fas fa-fw fa-table"></i>
            <span>View Groups</span></a>
        </li>
         <li class="nav-item">
