...
<div class="container">
          ...
          <form>
            ...
            <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-md-6">
                  <div class="form-label-group">
                    <input type="password" name="confirmPassword" id="confirmPassword" placeholder="Comfirm Password" class="confirmPassword form-control">
                    <label for="confirmPassword">Confirm password</label>
                  </div>
                </div>
              </div>
            </div>
            <input type="button" name="btnRegister" class="btnRegister btn btn-primary btn-block" value="UPDATE">
    ...
    <script src="<?php echo(URL); ?>libs/public/js/edituser.js"></script>